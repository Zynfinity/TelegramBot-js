...
export const tiktokapi = async (url) => {
...
export const playstore = async (name) => {
...
export const tikdown = async (url) => {
    if (!/tiktok/.test(url)) return (error.link)
...
export const peakpx = async (query) => {
    return new Promise(async (resolve, reject) => {
        const results = [];
...
export const mdlinfo = async (url) => {
    return new Promise((resolve, reject) => {
        axios.get(url).then(({
            data
        }) => {
...
export const jadwalmplid = async () => {
    return new Promise((resolve, reject) => {
...
export const musicaldown = async (URL) => {
    if (!/tiktok/.test(URL)) return (error.link)
...
export const ggtiktok = async (url) => {
    return new Promise(async (resolve, reject) => {
        try {
...
export const twitterdl2 = async (url) => {
    return new Promise(async (resolve, reject) => {
        const param = {
            URL: url
        }
...
export const twitterdl = async (url) => {
    return new Promise(async (resolve, reject) => {
        try {
            if (url.includes('?s=')) {
                url = url.split('?s=')[0]
...
export const infoloker = async (query) => {
    return new Promise((resolve, reject) => {
        axios
...
export const libur = async (tahun) => {
...
export const cuaca = async (place) => {
...
export const tiktoktrend = async () => {
...
export const asupanfilminfo = async (link) => {
    const {
        data
...
export const gsmarena = async (query) => {
    var {
        data
...
export const stickerTelegram = async (query, page = '1') => {
    const {
        data
...
export const stickerLine = async (query) => {
    const {
        data
...
export const youtube = async (link, type, quality = "480p") => {
    return new Promise(async (resolve, reject) => {
        ...
        if (ytIdRegex.test(link)) {
            ...
            const res = await axios('https://www.y2mate.com/mates/id830/analyzeV2/ajax', {
                method: 'POST',
                data: new URLSearchParams(Object.entries(config)),
                headers: headerss
            })
            let { title, vid } = res.data
            const select = type == "mp4" ? (Object.values(res.data.links.mp4)).find(s => s.q == quality) : (Object.values(res.data.links.mp3)).find(s => s.q == "128kbps")
            ...
            const { data } = await axios('https://www.y2mate.com/mates/convertV2/index', {
                method: 'POST',
                headers: headerss,
                data: new URLSearchParams(Object.entries(conf))
            })
            const { dlink } = data
            resolve({
                status: true,
...
export const reverseVideoFile = (path) => {
    return new Promise((resolve, reject) => {
...
export const webp2gifFile = (path) => {
    return new Promise((resolve, reject) => {
...
export const ghuser = async (user) => {
    return new Promise(async (resolve, reject) => {
        await axios
...
export const ghrepo = async (repo) => {
    return new Promise(async (resolve, reject) => {
        await axios
...
export const Quran = async (surah, ayat) => {
    return new Promise((resolve, reject) => {
        axios
...
export const ccchecker = async (cc) => {
    return new Promise((resolve, reject) => {
        const options = {
            method: 'POST',
...
export const jadwaltv = async (channel) => {
    return new Promise((resolve, reject) => {
...
export const emoji = async (emoji) => {
    return new Promise((resolve, reject) => {
...
export const ceritahantu = async () => {
    return new Promise((resolve, reject) => {
...
export const snapinsta = async (link) => {
    return new Promise((resolve, reject) => {
...
export const pinterestdl = async (link) => {
    return new Promise((resolve, reject) => {
        const options = {
            method: 'POST',
...
export const dddtik = async (link) => {
    return new Promise((resolve, reject) => {
        const options = {
            method: 'POST',
...
export const lafadz = async (query) => {
    return new Promise((resolve, reject) => {
...
export const surat = async (surah) => {
    return new Promise((resolve, reject) => {
...
export const rexdl = async (query) => {
...
export const rexdldown = async (link) => {
    return new Promise((resolve) => {
        axios.get(link).then(({
            data
        }) => {
...
export const merdekanews = async () => {
    return new Promise((resolve) => {
...
export const anondl = async (link) => {
    return new Promise((resolve) => {
        axios.get(link).then(({
            data
        }) => {
...
export const asupanfilm = async (query) => {
    return new Promise((resolve) => {
...
export const randomtt = async (query) => {
    return new Promise((resolve, reject) => {
...
export const trendtwit = (country) => {
    return new Promise((resolve, reject) => {
        axios
...
export const pinterest = async (querry) => {
    return new Promise(async (resolve, reject) => {
        axios
...
export const goredl = async (link) => {
    return new Promise(async (resolve, reject) => {
        axios
            .get(link)
            .then(({
...
export const webtoons = async (query) => {
    return new Promise((resolve, reject) => {
        axios
...
export const soundcloud = async (link) => {
    return new Promise((resolve, reject) => {
        const options = {
            method: 'POST',
...
// export const igstalk = async (username) => {
//     return new Promise(async (resolve, reject) => {
//         let {
//             data
...
export const resepmasakan = async (query) => {
...
export const searchgore = async (query) => {
    return new Promise(async (resolve, reject) => {
...
export const textmakervid = async (text1, style) => {
    if (style == 'poly') {
        var tstyle = 0
    } else if (style == 'bold') {
        var tstyle = 1
...
export const apkmirror = async (query) => {
    return new Promise((resolve, reject) => {
        axios
...
export const sfiledown = async (link) => {
    return new Promise((resolve, reject) => {
        axios
            .get(link)
            .then(({
...
export const corona = async (country) => {
...
export const mangatoon = async (search) => {
...
export const palingmurah = async (produk) => {
    if (!produk) {
...
export const sfilesearch = (query) => {
    return new Promise((resolve, reject) => {
        axios
...
export const wikisearch = async (query) => {
...
export const wallpaperhd = (chara) => {
    return new Promise((resolve, reject) => {
        axios
